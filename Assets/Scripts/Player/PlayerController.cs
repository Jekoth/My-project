...
public class PlayerController : MonoBehaviour
{
    ...
    {
        //Jos painettiin ensimmäisen kerran ja
        if (context.phase == InputActionPhase.Started)
        {
            //Ollaan maassa
            if (IsGrounded())
            {
                //lisää ylöspäin suuntautuva voima y-akseliin.
    ...
    {
        //Jos hiiri on lukittu, aseta se arvoon ei mitään muuten aseta hiiri lukitustilaan
        Cursor.lockState = toggle ? CursorLockMode.None : CursorLockMode.Locked;
        //Voi näyttää asetettuna vaihtokytkimen vastakkaiselle puolelle()
        canLook = !toggle;
    }
}
